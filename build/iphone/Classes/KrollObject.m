...
//@interface GoApplicationObject : NSObject
//@end

@interface GoApplicationObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GoApplicationObject class]])
		{
			for (NSString *key in [[(GoApplicationObject*)o modules] allKeys])
			{
