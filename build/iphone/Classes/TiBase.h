...
// in simulator we redefine to format for GoApplication Developer console
...
{\
	NSString * exceptionName = [@"org.goapplication." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.goapplication";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIGoApplicationNativeItemNone = -1, 
	UIGoApplicationNativeItemSpinner = -2,
	UIGoApplicationNativeItemProgressBar = -3,
	
	UIGoApplicationNativeItemSlider = -4,
	UIGoApplicationNativeItemSwitch = -5,
	UIGoApplicationNativeItemMultiButton = -6,
	UIGoApplicationNativeItemSegmented = -7,
	
	UIGoApplicationNativeItemTextView = -8,
	UIGoApplicationNativeItemTextField = -9,
	UIGoApplicationNativeItemSearchBar = -10,
	
	UIGoApplicationNativeItemPicker = -11,
	UIGoApplicationNativeItemDatePicker = -12,
	
	UIGoApplicationNativeItemInfoLight = -13,
	UIGoApplicationNativeItemInfoDark = -14,
	
	UIGoApplicationNativeItemDisclosure = -15,
	
	UIGoApplicationNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all GoApplication instances of
