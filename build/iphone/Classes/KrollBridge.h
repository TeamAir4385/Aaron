...
@interface GoApplicationObject : KrollCoverageObject {
#else
@interface GoApplicationObject : KrollObject {
#endif
@private
...
extern NSString * GoApplication$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	GoApplicationObject *_goapplication;
    KrollObject* console;
	BOOL shutdown;
