...
//Rare exceptions to indicate a bug in the _goapplication code (Eg, function that a subclass should have implemented)
...
/**
 The base class for GoApplication proxies.
 */
