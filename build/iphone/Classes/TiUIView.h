...
/**
 Base class for all GoApplication views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the GoApplication view hierarchy (such as wrapped iOS UIViews) was touched.
